    ...
    <div className="bg-slate-400 py-20 px-10 flex-col space-y-5 min-h-screen">
      <div className="bg-white p-6 rounded-3xl shadow-2xl">
        ...
        <div className="flex justify-center">
          <button className="mt-5 bg-blue-500 text-white p-3 text-center w-3/4 mx-auto rounded-xl hover:bg-teal-500 hover:text-black active:bg-yellow-500 focus:bg-red-500">
            Checkout
          </button>
        </div>
      </div>
      <div className="bg-white overflow-hidden rounded-3xl shadow-2xl">
        ...
        <div className="rounded-3xl p-6 bg-white relative -top-5">
          ...
          <div className="relative flex flex-col items-center -mt-10 -mb-5">
            <span className="text-lg font-bold">Tono Molloy</span>
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-5">
              <button className=" rounded-lg bg-blue-200 flex justify-center items-center aspect-square w-8 font-medium text-gray-500">
                -
              </button>
              <span>1</span>
              <button className=" rounded-lg bg-blue-200 flex justify-center items-center aspect-square w-8 font-medium text-gray-500">
